...
(function() {
  var app, ca, cardHeight, cardSprites, cardWidth, clearStage, clickCard, draw, end, faceDown, getName, graphics, input, join, leftArr, max, nameStyle, noplay, onClickJoin, onClickLeft, onClickNo, onClickReady, onClickRight, onClickUno, playerName, ready, readyToPlay, rightArr, scale, start, ubutt, upCard, welcome;
