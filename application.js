...
(function() {
  var app, ca, cardHeight, cardSprites, cardWidth, clearStage, clickCard, draw, end, faceDown, graphics, leftArr, max, noplay, onClickLeft, onClickNo, onClickRight, onClickUno, rightArr, scale, start, ubutt, upCard, welcome;
  ...
  welcome = function() {
    var unoGraphic, welcStyle, welcomePageHead;
