...
(function() {
  var app, ca, cardHeight, cardWidth, clearStage, draw, end, faceDown, graphics, leftArr, max, noplay, onClickLeft, onClickNo, onClickRight, onClickUno, rightArr, scale, start, ubutt, upCard;
