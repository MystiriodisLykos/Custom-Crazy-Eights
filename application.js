...
(function() {
  var Card, app, blue, ca, ca2, card1, card2, card3, card4, card5, cardHeight, cardSprites, cardWidth, clearStage, clickBlue, clickCard, clickGreen, clickRed, clickYellow, currentCard, draw, end, faceDown, getCheck, getName, graphics, green, input, join, leftArr, listDict, max, nameCount, nameStyle, noplay, onClickJoin, onClickLeft, onClickNo, onClickReady, onClickRight, onClickUno, pickColor, playerName, ready, readyToPlay, red, rightArr, scale, start, ubutt, welcStyle, welcome, wild, yellow;
