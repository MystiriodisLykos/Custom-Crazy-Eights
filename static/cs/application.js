...
(function() {
  var app, ca, cardHeight, cardSprites, cardWidth, clearStage, clickCard, draw, end, faceDown, getCheck, getName, graphics, input, join, leftArr, listDict, max, nameCount, nameStyle, noplay, onClickJoin, onClickLeft, onClickNo, onClickReady, onClickRight, onClickUno, playerName, ready, readyToPlay, rightArr, scale, server, start, ubutt, upCard, welcome, ws_scheme;
